...
### 5. 통계 및 시각화
- ✅ 부스별 실시간 통계 (참가자 수, 성별/교급 분포, 시간대별 현황)
- ✅ 행사별 통계 집계
- ✅ 전체 통계 대시보드
...
1. **대시보드 UI 완성** - 관리자 및 운영자 대시보드 구현
2. **방명록 폼 구현** - 단계별 참가자 등록 폼
3. **CSV Export** - 참가자 데이터 다운로드 기능
